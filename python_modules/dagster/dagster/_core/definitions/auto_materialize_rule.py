...
if TYPE_CHECKING:
    from dagster._core.definitions.asset_condition import AssetConditionEvaluationInfo
...
class MaterializeOnRequiredForFreshnessRule(
    ...
    def evaluate_for_asset(
        ...
        from .asset_condition import AssetConditionEvaluationInfo

        true_subset, subsets_with_metadata = freshness_evaluation_results_for_asset_key(
            context.root_context
        )
        return AssetConditionEvaluationInfo.create(context, true_subset, subsets_with_metadata)
...
class MaterializeOnCronRule(
    ...
    def evaluate_for_asset(
        ...
        return AssetConditionEvaluationInfo.create(context, true_subset=asset_subset_to_request)
...
class MaterializeOnMissingRule(AutoMaterializeRule, NamedTuple("_MaterializeOnMissingRule", [])):
    ...
    def get_handled_subset(self, context: AssetConditionEvaluationContext) -> AssetSubset:
        ...
        previous_handled_subset = (
            context.previous_evaluation_info.get_extra_state(context.condition, AssetSubset)
            if context.previous_evaluation_info
            else None
        )
...
class SkipOnBackfillInProgressRule(
    ...
    def evaluate_for_asset(
        ...
        return AssetConditionEvaluationInfo.create(context, true_subset)
