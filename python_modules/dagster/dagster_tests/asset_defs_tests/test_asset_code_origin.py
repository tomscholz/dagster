...
def test_asset_code_origins():
    ...
    expected_origins = {
        ...
        "chuck_berry": dagster_module_path
        + ":"
        + path_in_module
        + "asset_package/module_with_assets.py:11",
        "little_richard": dagster_module_path
        + ":"
        + path_in_module
        + "asset_package/__init__.py:4",
        "fats_domino": dagster_module_path + ":" + path_in_module + "asset_package/__init__.py:16",
        "miles_davis": dagster_module_path
        + ":"
        + path_in_module
